...
//        addressline.addGradientLayer(topColor: color1, bottomColor: color2)
    ...
    @objc func saveTap(_ sender: UITapGestureRecognizer) {
        ...
        let newEvent = Event(creator_username: currentUser!.username, title: prev_data["title"], description: prev_data["description"], startDate: prev_data["start"], endDate: prev_data["end"], location: newLocation, capacity: -1, visibility: "tbi", tags: self.tags, attendees: [currentUser!.username])
