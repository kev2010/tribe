...
class FilterTable: UITableViewHeaderFooterView {
    ...
    override init(reuseIdentifier: String?) {
        ...
        addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(FilterTable.tapHeader(_:))))
    }
    ...
    @objc func tapHeader(_ gestureRecognizer: UITapGestureRecognizer) {
        guard let cell = gestureRecognizer.view as? FilterTable else {
            return
        }
